...
describe('POI endpoints...', () => {
	...
	test('Add 1st Image...', () => {
		var image1Data = new FormData(); image1Data.append('file', FS.createReadStream(Path.join(AppDir, 'assets', 'test', 'cafe.jpg')));
	...
	test('Add 2nd Image...', () => {
		var image2Data = new FormData(); image2Data.append('file', FS.createReadStream(Path.join(AppDir, 'assets', 'test', 'book.jpg')));
	...
	test('Add 3rd Image...', () => {
		var image3Data = new FormData(); image3Data.append('file', FS.createReadStream(Path.join(AppDir, 'assets', 'test', 'gym.jpg')));
